...
import { SPRING_SMOOTH, STAGGER_SLOW, useTimeScale } from "../../../../shared/lib/timing";
...
export const SalesCounter: React.FC<Props> = ({ lang }) => {
  ...
  const counterProgress = interpolate(frame, [f(20), f(180)], [0, 1], {
  ...
  const pulseScale = isPulsing
    ? interpolate(frame, [f(180), f(195), f(210)], [1, 1.08, 1], {
        extrapolateLeft: "clamp",
        extrapolateRight: "clamp",
      })
    : 1;
    ...
    >
        ...
        <div style={{ textAlign: "center" }}>
          <div
            style={{
              ...
              filter: isPulsing ? `drop-shadow(${SHADOWS.primaryGlow})` : "none",
            }}
          >
      ...
      >
        {salesData.competitors.map((comp, i) => {
          const delay = d(30 + i * STAGGER_SLOW);
