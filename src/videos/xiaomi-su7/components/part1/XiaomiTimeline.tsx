...
import { SPRING_SMOOTH, STAGGER_DRAMATIC, useTimeScale } from "../../../../shared/lib/timing";
...
export const XiaomiTimeline: React.FC<Props> = ({ lang }) => {
  ...
  const lineProgress = interpolate(frame, [f(20), f(200)], [0, 1], {
  ...
  return (
    ...
    >
      ...
      {xiaomiTimeline.map((item, i) => {
        ...
        const dotDelay = d(20 + i * STAGGER_DRAMATIC);
