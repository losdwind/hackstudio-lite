...
import { SPRING_SMOOTH, STAGGER_DRAMATIC } from "../../../../shared/lib/timing";
...
export const TalentFlowDiagram: React.FC<Props> = ({ lang }) => {
  ...
  const talentTitle = "talentFlowTitle" in content ? (content as Record<string, string>).talentFlowTitle : "Talent Flow";
  const dest = "destination" in content ? (content as Record<string, string>).destination : "Xiaomi Auto";
