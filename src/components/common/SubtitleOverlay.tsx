...
import type { WordTiming } from "../../data/alignment-manifest";
    ...
    return (
      ...
      >
        ...
        >
          ...
          >
            {words.map((word, i) => {
              // Convert absolute audio timestamps to local Sequence frames
              const wordStartFrame = Math.round(
                (word.start - lineStartTime) * fps
              );
              const wordEndFrame = Math.round(
                (word.end - lineStartTime) * fps
              );
