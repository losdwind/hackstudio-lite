...
import { SPRING_SMOOTH, STAGGER_DEFAULT, useTimeScale } from "../../../../shared/lib/timing";
...
export const EVPenetrationChart: React.FC<Props> = ({ lang }) => {
  ...
  const { d } = useTimeScale(300); // designed for 300 frames
    ...
    >
      ...
      >
        ...
        {evPenetrationData.map((item, i) => {
          const delay = d(15 + i * STAGGER_DEFAULT);
